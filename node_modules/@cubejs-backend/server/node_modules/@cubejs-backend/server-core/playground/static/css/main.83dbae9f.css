...
.ant-form-item-has-error .ant-input-affix-wrapper-focused {
  ...
  border-right-width: 1px !important;
  outline: 0;
  box-shadow: 0 0 0 2px rgba(255, 140, 171, 0.2);
}
...
.ant-menu-submenu-inline > .ant-menu-submenu-title .ant-menu-submenu-arrow::after {
  ...
  width: 6px;
  height: 1.5px;
  background-image: linear-gradient(to right, #43436b, #43436b);
  border-radius: 2px;
...
.ant-input-rtl .ant-select-focused.ant-select-single:not(.ant-select-customize-input) .ant-select-selector:not(.ant-select-disabled.ant-select-single:not(.ant-select-customize-input) .ant-select-selector) {
  border-right-width: 0;
  border-left-width: 1px !important;
}
...
.ant-input-rtl .ant-select-focused.ant-select-multiple .ant-select-selector:not(.ant-select-disabled.ant-select-multiple .ant-select-selector) {
  border-right-width: 0;
  border-left-width: 1px !important;
}
