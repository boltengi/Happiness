	...
	*/
	...
	function () {
	  function WebSocketTransportResult(_ref) {
	    ...
	    classCallCheck(this, WebSocketTransportResult);

	    this.status = status;
	    this.result = message;
	  }

	  createClass(WebSocketTransportResult, [{
	    key: "json",
	    value: function () {
	      var _json = asyncToGenerator(
	      /*#__PURE__*/
	  ...
	  createClass(WebSocketTransport, [{
	    ...
	    value: function request(method, _ref4) {
	      var baseRequestId = _ref4.baseRequestId,
	          params = objectWithoutProperties(_ref4, ["baseRequestId"]);
